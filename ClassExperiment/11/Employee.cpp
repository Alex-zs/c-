...
bool Employee::operator > (Employee &e){
    ...
    if(this->getAge(today) > e.getAge(today))
        return true;
    else
        return false;
}
...
int main() {
    ...
    Employee manager1("Bob1", "Blue1", Date(1960,8,1), hire);
    Employee manager2("Bob2", "Blue2", Date(1956,8,1), hire2);
    Employee manager3("Bob3", "Blue3", Date(1966,8,1), hire3);
    Employee manager4("Bob4", "Blue4", Date(1980,8,1), hire4);
    Employee manager5("Bob5", "Blue5", Date(1988,8,1), hire5);
    Employee employees[] = {manager1, manager2, manager3, manager4, manager5};
    Employee max;
    max = compare(employees, 5);
    max.print();
    cout << max.getAge(today) << endl;
    return 0;
}
